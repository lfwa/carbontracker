...
tracker = CarbonTracker(epochs=epochs, update_interval=0.1, stop_and_confirm=True, components="all", epochs_before_pred=1, monitor_epochs=1, verbose=2, ignore_errors=False)
#time.sleep(1)
